...
void TRTBatchedBEVNMS::configurePlugin(const nvinfer1::DynamicPluginTensorDesc* inputs, int nbInputs,
...
nvinfer1::DataType TRTBatchedBEVNMS::getOutputDataType(int index, const nvinfer1::DataType* inputTypes,
